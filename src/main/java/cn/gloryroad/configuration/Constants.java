...
public class Constants {
    //测试数据相关常量设定
    public static final String Path_ExcelFile = "D:\\IdeaProjects\\KeyWordsFrameWork\\src\\main\\java\\cn\\gloryroad\\data\\关键字驱动测试用例.xlsx";
    public static final String Path_ConfigurationFile = "D:\\IdeaProjects\\KeyWordsFrameWork\\objectMap.properties";
    //第一列用0表示，测试用例序号列
    public static final int Col_TestCaseID = 0;
    //第四列用3表示，为关键字列
    public static final int Col_KeyWordAction = 3;
    //第五列用4表示，为操作元素定位的表达式列
